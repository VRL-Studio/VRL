...
public interface IModelCommands {
    ...
    void insertVariableToScope(CodeEntity scope, Variable variable);

    void removeVariableFromScope(CodeEntity scope, Variable variable);
    ...
    // METHOD
    void removeVariableFromMethod(CodeEntity method, Variable variable);

    void insertVariableToMethod(CodeEntity method, Variable variable);
    ...
    void setVariableType(IType type, Variable codeEntity);
    ...
    //ARGUMENT
    void setConstTypeInArgument(IType type, Argument codeEntity);
