...
public class LongestCommonSubsequence {
    ...
    public static List<CodeEntity> lcs(List<CodeEntityWithIndex> a, List<CodeEntityWithIndex> b) {
        List<CodeEntity> x;
        List<CodeEntity> y;
        ...
        } else if (compareEntities(a.get(alen - 1).getCodeEntity(), b.get(blen - 1).getCodeEntity())) {
            List<CodeEntity> list = lcs(a.subList(0, alen - 1), b.subList(0, blen - 1));
            list.add(a.get(alen - 1).getCodeEntity());
            return list;
        } else {
