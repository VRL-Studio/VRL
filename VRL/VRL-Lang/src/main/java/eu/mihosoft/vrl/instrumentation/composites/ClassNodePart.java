...
public class ClassNodePart
		extends
		AbstractCodeBuilderPart<ClassNode, ClassDeclaration, CompilationUnitDeclaration> {

	public ClassNodePart(SourceUnit unit, VisualCodeBuilder builder,
	...
	public ClassDeclaration transform(ClassNode obj,
		...
		ClassDeclaration cd = builder.declareClass(parent,
				...
				convertModifiers(obj.getModifiers()), convertExtends(obj),
