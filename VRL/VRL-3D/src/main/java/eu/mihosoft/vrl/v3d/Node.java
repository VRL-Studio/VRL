...
public class Node {
    ...
    public List<Polygon> allPolygons() {
        ...
        if (this.front != null) polygons = Utils.concat(polygons, this.front.allPolygons());
        if (this.back != null) polygons = Utils.concat(polygons, this.back.allPolygons());
        return polygons;
    }
